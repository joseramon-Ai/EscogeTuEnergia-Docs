...
- **React Router 6.30.1** para navegación
- **React Query 5.83.0** para gestión de estado

### Backend
- **Node.js 20** + Express 5.1.0
- **TypeScript 5.9.3**
- **Prisma 6.19.0** como ORM
- **MySQL 8** como BD relacional
- **JWT** para autenticación segura

### Infraestructura
- **Docker + Docker Compose** para contenedorización
- **Nginx** como servidor web
- **Linux** como SO del servidor
...
**Licencia:** Propietario - Saturdays.AI  
**Último commit:** Enero 18, 2026
